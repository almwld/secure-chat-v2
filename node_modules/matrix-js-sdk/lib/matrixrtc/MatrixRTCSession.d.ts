...
import type { Statistics, RTCNotificationType, Status, IRTCNotificationContent, RTCCallIntent, Transport } from "./types.ts";
...
export declare class MatrixRTCSession extends TypedEventEmitter<MatrixRTCSessionEvent | MembershipManagerEvent, MatrixRTCSessionEventHandlerMap & MembershipManagerEventHandlerMap> {
     ...
     */
    static sessionMembershipsForSlot(room: Pick<Room, "getLiveTimeline" | "roomId" | "hasMembershipState" | "_unstable_getStickyEvents">, slotId: string, options?: SessionMembershipsForSlotOpts): Promise<CallMembership[]>;
    /**
    ...
    private recalculateSessionMembersDirty;
